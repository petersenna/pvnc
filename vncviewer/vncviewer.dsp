...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "omnithread" /I ".." /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "__NT__" /D "_WINSTATIC" /D "__WIN32__" /YX"stdhdrs.h" /FD /c
# SUBTRACT CPP /Fr
...
PreLink_Cmds=cl /nologo /MT /FoRelease\ /FdRelease\ /c buildtime.cxx
...
SOURCE="$(InputPath)"
PreLink_Desc=Setting build time...
PreLink_Cmds=cl /nologo /MTd /FoDebug\ /FdDebug\ /c buildtime.cxx
# End Special Build Tool
